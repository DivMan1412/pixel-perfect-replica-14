    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center bg-primary px-6 py-3 text-xs tracking-[0.2em] text-primary-foreground uppercase"
          >
            Go home
          </Link>
        </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "HIMORA — Crafted for Winter" },
      {
        name: "description",
        content: "Premium handcrafted Himalayan woollens: shawls, stoles, sadris, caps and winter wear.",
      },
      { property: "og:site_name", content: "HIMORA" },
